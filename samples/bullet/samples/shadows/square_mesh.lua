...
function makeBoxMesh ( xMin, yMin, zMin, xMax, yMax, zMax, texture )  
  ...
  vertexFormat:declareNormal( 5, MOAIVertexFormat.GL_FLOAT, 1 ) 
  
 local vertex_format = MOAIVertexFormat.new()

--       -- vertex position: x, y, z:
--      vertex_format:declareCoord ( 1, MOAIVertexFormat.GL_FLOAT, 3 )
--      -- texture coordinates: u, v
--      vertex_format:declareUV ( 2, MOAIVertexFormat.GL_FLOAT, 2 )
--      -- color (array of 4 floats)
--      vertex_format:declareColor (3, MOAIVertexFormat.GL_UNSIGNED_BYTE )
--      -- vertex normal: x, y, z
--      vertex_format:declareNormal( 4, MOAIVertexFormat.GL_FLOAT, 3 ) 
