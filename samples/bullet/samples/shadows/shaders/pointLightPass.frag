...
uniform float  u_lightAttenuation_x;
uniform float  u_lightAttenuation_y;
uniform float  u_lightAttenuation_z;
...
void main(void)
{
  ...
  vec3 u_lightPosition    = vec3(u_lightPosition_x,u_lightPosition_y,u_lightPosition_z); 
  vec3 u_lightAttenuation = vec3(u_lightAttenuation_x,u_lightAttenuation_y,u_lightAttenuation_z); 
