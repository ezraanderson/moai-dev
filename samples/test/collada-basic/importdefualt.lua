...
function colladaToMesh( colladafile, textureFile )
	...
	--load vertex data
  MOAIFileSystem.setWorkingDirectory("F://moai//pull//moai-dev//samples//test//collada-basic//")
  
    print("WORKING DIRECTORY",  MOAIFileSystem.getWorkingDirectory())
    print("FILENAME",colladafile)
    print("")
	...
	--mesh:setHigh(#vertexData['positionData'])
	return mesh
end
