...
///*********
//LOC
void MOAIVertexBuffer::writeFloat_loc (float a, float b ) {	    
...
//******************************************************
//COLOR
void MOAIVertexBuffer::writeColor_rgb ( float r,float g,float b, float a ) {
...
///*********
//SIZE
void MOAIVertexBuffer::writeFloat_size (float a ) {	
		this->mStream.Write < float   > ( a );
...
///*********
void MOAIVertexBuffer::writeFloat_uv (s8 a, s8 b ) {	
...
void MOAIVertexBuffer::bless_box ( ) {
...
// printf("LENGTH %d %d %d \n",this->mStream.GetLength (),this->mFormat->GetVertexSize (),this->mStream.GetLength () / this->mFormat->GetVertexSize ());
...
void MOAIVertexBuffer::ReserveV ( long size ) {
    long total = size; 
