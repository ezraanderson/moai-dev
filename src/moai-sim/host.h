...
AKU_API void			AKUSetInputDeviceGameAnalog     ( int deviceID, int sensorID, char const* name );  
AKU_API void			AKUSetInputDeviceGameButton     ( int deviceID, int sensorID, char const* name );
