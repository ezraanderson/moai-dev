...
//	state.SetField(-1, "TILE_X_FLIP", (u32)MOAITileFlags::X_FLIP);
//	state.SetField(-1, "TILE_Y_FLIP", (u32)MOAITileFlags::Y_FLIP);
//	state.SetField(-1, "TILE_R_FLIP", (u32)MOAITileFlags::R_FLIP);

	state.SetField ( -1, "TILE_X_FLIP", ( u32 )MOAITileFlags::XFLIP );
	state.SetField ( -1, "TILE_Y_FLIP", ( u32 )MOAITileFlags::YFLIP );
	state.SetField (-1, "TILE_R_FLIP", (u32) MOAITileFlags::RFLIP);
