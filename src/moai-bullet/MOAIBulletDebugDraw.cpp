...
//**************************************************************************
		...
		//	//FROM
						...
						////FROM
						//		ZLVec3D vtx_fromA;
						//		vtx_fromA.mX = from.x() * this->mScale+50;
						//		vtx_fromA.mY = from.y() * this->mScale+50;
						//		vtx_fromA.mZ = from.z() * this->mScale+50;
						//		gfxDevice.WriteVtx ( vtx_fromA );
						//		gfxDevice.WriteFinalColor4b ();

						//	//TO
						//		ZLVec3D vtx_toA;
						//		vtx_toA.mX = to.x() * this->mScale;
						//		vtx_toA.mY = to.y() * this->mScale;
						//		vtx_toA.mZ = to.z() * this->mScale+50;
						//		gfxDevice.WriteVtx ( vtx_toA );
						//		gfxDevice.WriteFinalColor4b ();
