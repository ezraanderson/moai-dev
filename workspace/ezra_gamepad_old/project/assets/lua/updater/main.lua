...
local font = MOAIFont.new ()
		font:loadFromTTF ('updater/arialrounded.ttf', charcodes, 8, 163 )
...
--task_post:setTimeout(1000)
--print('STEPC')
	 -- task_post:setUserAgent ( "task_smash" )
--print('STEPD')
	  task_post:setVerbose ( true )
--print('STEPE')
...
print('CHANGE TO OUYA DEMO HOST')
		local 	luaPath =  system['cacheDirectory']..'//'..game_name
		package.path 	 =  luaPath.."/?.lua"
		package.gamepath =  luaPath
