...
package com.ezraanderson.particlesoup;
...
/*	
	...
	*/
	...
	int xx = (int) Math.round (event.getX ( pointerIndex )*mScale);
	int yy = (int) Math.round (event.getY ( pointerIndex )*mScale);
	...
	public boolean onKeyUp(int keyCode, KeyEvent event) {
		...
		int idPlayer = OuyaController.getPlayerNumByDeviceId(event
				.getDeviceId());
		Moai.enqueueGameButtonEvent(0,
				Moai.InputSensor.SENSOR_GAMEBUTTON.ordinal(), idPlayer, false,keyCode);
