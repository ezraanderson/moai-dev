...
//BUFFERS
MOAIEzraVertexBuffer * vbo;
MOAIEzraIndexBuffer * ibo;
...
/**	@name	clear
	...
	@in		MOAIEzraParticleLayer self
	@out	nil
*/
int MOAIEzraParticleLayer::_clear ( lua_State* L ) {
	MOAI_LUA_SETUP ( MOAIEzraParticleLayer, "U" )
...
*/
int MOAIEzraParticleLayer::_getFitting ( lua_State* L ) {
	MOAI_LUA_SETUP ( MOAIEzraParticleLayer, "UNNNN" )
...
*/
int	MOAIEzraParticleLayer::_getPartition ( lua_State* L ) {
	MOAI_LUA_SETUP ( MOAIEzraParticleLayer, "U" )
...
/**	@name	GET TOTAL
*/
int	MOAIEzraParticleLayer::_total ( lua_State* L ) {
	MOAI_LUA_SETUP ( MOAIEzraParticleLayer, "U" )
...
/**	@name	getSortMode
	...
	@out	number sortMode
*/
int MOAIEzraParticleLayer::_getSortMode ( lua_State* L ) {
	MOAI_LUA_SETUP ( MOAIEzraParticleLayer, "U" )
...
/**	@name	getSortScale
	...
	@in		MOAIEzraParticleLayer2D self
	@out	number x
	@out	number y
	@out	number priority
*/
int	MOAIEzraParticleLayer::_getSortScale ( lua_State* L ) {
	MOAI_LUA_SETUP ( MOAIEzraParticleLayer, "U" )
...
/**	@name	setBox2DWorld
	...
	@in		MOAIEzraParticleLayer self
	@in		MOAIEzraParticleLayer2DWorld world
	@out	nil
*/
int MOAIEzraParticleLayer::_setBox2DWorld ( lua_State* L ) {
	MOAI_LUA_SETUP ( MOAIEzraParticleLayer, "UU" )
	
	#if USE_BOX2D
		self->mBox2DWorld.Set ( *self, state.GetLuaObject < MOAIEzraParticleLayer2DWorld >( 2, true ));
	#endif
	return 0;
}
...
/**	@name	setCamera
	...
	@overload
		...
		@out	nil
*/
int MOAIEzraParticleLayer::_setCamera ( lua_State* L ) {
	MOAI_LUA_SETUP ( MOAIEzraParticleLayer, "U" )
...
/**	@name	setCpSpace
	...
	@out	nil
*/
int MOAIEzraParticleLayer::_setCpSpace ( lua_State* L ) {
	MOAI_LUA_SETUP ( MOAIEzraParticleLayer, "UU" )
...
/**	@name	setParallax
	...
	@out	nil
*/
int MOAIEzraParticleLayer::_setParallax ( lua_State* L ) {
	MOAI_LUA_SETUP ( MOAIEzraParticleLayer, "U" )
...
/**	@name	setPartition
	...
	@out	nil
*/
int MOAIEzraParticleLayer::_setPartition ( lua_State* L ) {
	MOAI_LUA_SETUP ( MOAIEzraParticleLayer, "UU" )
...
/**	@name	setPartitionCull2D
	...
	@out	nil
*/
int	MOAIEzraParticleLayer::_setPartitionCull2D ( lua_State* L ) {
	MOAI_LUA_SETUP ( MOAIEzraParticleLayer, "U" )
...
/**	@name	setSortMode
	...
	@in		MOAIEzraParticleLayer self
	@in		number sortMode		One of MOAIEzraParticleLayer.SORT_NONE, MOAIEzraParticleLayer.SORT_PRIORITY_ASCENDING,
								MOAIEzraParticleLayer.SORT_PRIORITY_DESCENDING, MOAIEzraParticleLayer.SORT_X_ASCENDING,
								MOAIEzraParticleLayer.SORT_X_DESCENDING, MOAIEzraParticleLayer.SORT_Y_ASCENDING,
								MOAIEzraParticleLayer.SORT_Y_DESCENDING, MOAIEzraParticleLayer.SORT_Z_ASCENDING,
								MOAIEzraParticleLayer.SORT_Z_DESCENDING
	@out	nil
*/
int MOAIEzraParticleLayer::_setSortMode ( lua_State* L ) {
	MOAI_LUA_SETUP ( MOAIEzraParticleLayer, "U" )
...
/**	@name	setSortScale
	...
	@out	nil
*/
int	MOAIEzraParticleLayer::_setSortScale ( lua_State* L ) {
	MOAI_LUA_SETUP ( MOAIEzraParticleLayer, "U" )
...
/**	@name	setViewport
	...
	@out	nil
*/
int MOAIEzraParticleLayer::_setViewport ( lua_State* L ) {
	MOAI_LUA_SETUP ( MOAIEzraParticleLayer, "UU" )
...
/**	@name	showDebugLines
	...
	@out	nil
*/
int	MOAIEzraParticleLayer::_showDebugLines ( lua_State* L ) {
	MOAI_LUA_SETUP ( MOAIEzraParticleLayer, "U" )
...
/**	@name	wndToWorld
	...
	@out	number zn
*/
int MOAIEzraParticleLayer::_wndToWorld ( lua_State* L ) {
	MOAI_LUA_SETUP ( MOAIEzraParticleLayer, "UNN" )
...
/**	@name	worldToWnd
	...
	@out	number z
*/
int MOAIEzraParticleLayer::_worldToWnd ( lua_State* L ) {
	MOAI_LUA_SETUP ( MOAIEzraParticleLayer, "UNN" )
...
//----------------------------------------------------------------//
void MOAIEzraParticleLayer::AffirmPartition () {
...
//----------------------------------------------------------------//
void MOAIEzraParticleLayer::GetBillboardMtx ( ZLMatrix4x4& billboard ) {
...
//----------------------------------------------------------------//
float MOAIEzraParticleLayer::GetFitting ( ZLRect& worldRect, float hPad, float vPad ) {
...
//----------------------------------------------------------------//
void MOAIEzraParticleLayer::GetProjectionMtx ( ZLMatrix4x4& proj ) {
...
//----------------------------------------------------------------//
u32 MOAIEzraParticleLayer::GetPropBounds ( ZLBox& bounds ) {
...
//----------------------------------------------------------------//
void MOAIEzraParticleLayer::GetViewMtx ( ZLMatrix4x4& view ) {
...
//----------------------------------------------------------------//
void MOAIEzraParticleLayer::GetWndToWorldMtx ( ZLMatrix4x4& wndToWorld ) {
	this->GetWorldToWndMtx ( wndToWorld );
	wndToWorld.Inverse ();
}

//----------------------------------------------------------------//
void MOAIEzraParticleLayer::GetWorldToWndMtx ( ZLMatrix4x4& worldToWnd ) {
...
//**************************************************************************************************
//RESULTS
void MOAIEzraParticleLayer::results () {
...
//**************************************************************************************************
//RESULTS
int	MOAIEzraParticleLayer::_results ( lua_State* L ) {
	MOAI_LUA_SETUP ( MOAIEzraParticleLayer, "U" )	
	self->results ();
	return 0;
}
...
//----------------------------------------------------------------//
//COLLSION
void  MOAIEzraParticleLayer::Collide(MOAIProp * circleA, MOAIProp * circleB){
...
//***************************************************************************************************************
//***************************************************************************************************************
void MOAIEzraParticleLayer::Loop () {
...
//*********************************************************************************************
//EZRA
void MOAIEzraParticleLayer::Draw ( int subPrimID ) {
	UNUSED ( subPrimID );
...
/**	@name	insertProp
	...
	@out	nil
*/
int	MOAIEzraParticleLayer::_insertProp ( lua_State* L ) {
	MOAI_LUA_SETUP ( MOAIEzraParticleLayer, "UU" )
...
/**	@name	removeProp
	...
	@out	nil
*/
int	MOAIEzraParticleLayer::_removeProp ( lua_State* L ) {
	MOAI_LUA_SETUP ( MOAIEzraParticleLayer, "UU" )
...
int	MOAIEzraParticleLayer::_setforce ( lua_State* L ) {
...
//**************************************************************************************************
//THREAD
int	MOAIEzraParticleLayer::_threadMake ( lua_State* L ) {
	MOAI_LUA_SETUP ( MOAIEzraParticleLayer, "U" )
...
//**************************************************************************************************
//START
int	MOAIEzraParticleLayer::_threadStart ( lua_State* L ) {
...
//**************************************************************************************************
//STOP
int	MOAIEzraParticleLayer::_threadStop ( lua_State* L ) {
...
//**************************************************************************************************
//RELEASE
int	MOAIEzraParticleLayer::_threadRelease ( lua_State* L ) {
...
//**************************************************************************************************
//SOUP
int	MOAIEzraParticleLayer::_soup ( lua_State* L ) {
	MOAI_LUA_SETUP ( MOAIEzraParticleLayer, "U" )	
...
//**************************************************************************************************
//SOUP
int	MOAIEzraParticleLayer::_bounds ( lua_State* L ) {
	MOAI_LUA_SETUP ( MOAIEzraParticleLayer, "U" )	
...
//**************************************************************************************************
//SOUP
int	MOAIEzraParticleLayer::_size ( lua_State* L ) {
	MOAI_LUA_SETUP ( MOAIEzraParticleLayer, "U" )	
...
//**************************************************************************************************
//SHADER
int	MOAIEzraParticleLayer::_shader ( lua_State* L ) {
	MOAI_LUA_SETUP ( MOAIEzraParticleLayer, "U" )	
...
int	MOAIEzraParticleLayer::_insertDraw ( lua_State* L ) {
	MOAI_LUA_SETUP ( MOAIEzraParticleLayer, "UU" )
...
//**************************************************************************************************
//SET TEXTURE
int	MOAIEzraParticleLayer::_texture ( lua_State* L ) {
	MOAI_LUA_SETUP ( MOAIEzraParticleLayer, "U" )	
...
//**************************************************************************************************
//SET BUFFERS
int	MOAIEzraParticleLayer::_buffers ( lua_State* L ) {
	MOAI_LUA_SETUP ( MOAIEzraParticleLayer, "U" )	
	vbo	= state.GetLuaObject < MOAIEzraVertexBuffer>( 2, false );
	ibo	= state.GetLuaObject < MOAIEzraIndexBuffer>( 3, false );
...
//**************************************************************************************************
//SET BOOM
int	MOAIEzraParticleLayer::_boom ( lua_State* L ) {
	MOAI_LUA_SETUP ( MOAIEzraParticleLayer, "U" )	
...
//**************************************************************************************************
//BOUNCE
int	MOAIEzraParticleLayer::_bounce ( lua_State* L ) {
	MOAI_LUA_SETUP ( MOAIEzraParticleLayer, "U" )	
	self->mBounce = state.GetValue < bool >( 2, true );
	return 0;
};
...
//**************************************************************************************************
//BOUNCE
int	MOAIEzraParticleLayer::_color ( lua_State* L ) {
	MOAI_LUA_SETUP ( MOAIEzraParticleLayer, "U" )	
...
//**************************************************************************************************
//BOUNCE
int	MOAIEzraParticleLayer::_high ( lua_State* L ) {
	MOAI_LUA_SETUP ( MOAIEzraParticleLayer, "U" )	
...
//**************************************************************************************************
MOAIEzraParticleLayer::MOAIEzraParticleLayer () :
...
//*******************************************************************************
//END
void MOAIEzraParticleLayer::Finalize() {
...
//----------------------------------------------------------------//
void MOAIEzraParticleLayer::Clear () {
...
//	//this->mMutex.Unlock ();
//
//  printf("\n \n **** 4. MOAIEzraParticleLayer --> FIRE DESTRUCTOR  ****  \n\n");
...
//----------------------------------------------------------------//
void MOAIEzraParticleLayer::RegisterLuaClass ( MOAILuaState& state ) {
...
//----------------------------------------------------------------//
void MOAIEzraParticleLayer::RegisterLuaFuncs ( MOAILuaState& state ) {
...
//----------------------------------------------------------------//
void MOAIEzraParticleLayer::Render () {	
	this->Draw ( MOAIProp::NO_SUBPRIM_ID );
}

//**********************************************************************************
//----------------------------------------------------------------//
void MOAIEzraParticleLayer::SerializeIn ( MOAILuaState& state, MOAIDeserializer& serializer ) {
	//MOAIProp::SerializeIn ( state, serializer );
}

//----------------------------------------------------------------//
void MOAIEzraParticleLayer::SerializeOut ( MOAILuaState& state, MOAISerializer& serializer ) {
