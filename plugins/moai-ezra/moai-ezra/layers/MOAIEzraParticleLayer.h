#ifndef	MOAIEZRAPARTICLELAYER_H
#define	MOAIEZRAPARTICLELAYER_H
...
class MOAIEzraParticleLayer2DWorld;
class MOAICamera;
class MOAICpSpace;
//class MOAIEzraTask;
...
//================================================================//
// MOAIEzraParticleLayer
//================================================================//
/**	@name	MOAIEzraParticleLayer
...
private:
	...
	#if MOAI_WITH_BOX2D
		MOAILuaSharedPtr < MOAIEzraParticleLayer2DWorld >	mBox2DWorld;
	#endif
...
public:	
	DECL_LUA_FACTORY ( MOAIEzraParticleLayer )
