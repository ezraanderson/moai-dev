...
const USVec2D SSAOPass::s_quadVerts[] = {
  USVec2D(-1.0f, -1.0f),
  USVec2D(1.0f, -1.0f),
  USVec2D(1.0f, 1.0f),
  USVec2D(-1.0f, 1.0f)
...
const USVec2D SSAOPass::s_quadTexCoords[] = {
  USVec2D(0.0f, 0.0f),
  USVec2D(1.0f, 0.0f),
  USVec2D(1.0f, 1.0f),
  USVec2D(0.0f, 1.0f)
...
//***************************************************************************************************
void SSAOPass::setCameraProperties(const ZLMatrix4x4& invProjMatrix, float farDistance) {
