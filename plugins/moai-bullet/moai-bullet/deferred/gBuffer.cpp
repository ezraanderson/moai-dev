...
bool GBuffer::setupFbo(unsigned int windowWidth, unsigned int windowHeight) {
  ...
  printf("3. GBuffer::setupFbo --> SETTING UP THE FBO\n");
...
void GBuffer::loadShaders() {			
	//printf("2. GBuffer::loadShaders --> ERROR NO SHADERS\n");
...
u32 GBuffer::getTexture(GBUFFER_TEXTURE_TYPE textureType) {
