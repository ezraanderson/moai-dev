...
#ifndef	MOAIVOXELPROP_H
#define	MOAIVOXELPROP_H
...
private:
	...
	ZLLeanLink < MOAIVoxelProp* >	mLinkInCell;
	MOAIVoxelProp*					mNextResult;
...
public:
	...
	DECL_LUA_FACTORY ( MOAIVoxelProp )
	DECL_ATTR_HELPER ( MOAIVoxelProp )
