...
/**	@name	getBounds
	...
	@out	number zMax
*/
int MOAIVoxelProp::_getBounds ( lua_State* L ) {
	MOAI_LUA_SETUP ( MOAIVoxelProp, "U" )
...
/**	@name	getWorldBounds
	...
	@out	number zMax
*/
int MOAIVoxelProp::_getWorldBounds ( lua_State* L ) {
	MOAI_LUA_SETUP ( MOAIVoxelProp, "U" )
...
/**	@name	getDeck
	...
	@out	MOAIDeck deck
*/
int MOAIVoxelProp::_getDeck ( lua_State* L ) {
	MOAI_LUA_SETUP ( MOAIVoxelProp, "U" )
...
*/
int MOAIVoxelProp::_getDims ( lua_State* L ) {
	MOAI_LUA_SETUP ( MOAIVoxelProp, "U" )
...
*/
int MOAIVoxelProp::_getGrid ( lua_State* L ) {
	MOAI_LUA_SETUP ( MOAIVoxelProp, "U" )
...
/**	@name	getIndex
	...
	@out	number index
*/
int MOAIVoxelProp::_getIndex ( lua_State* L ) {
	MOAI_LUA_SETUP ( MOAIVoxelProp, "U" )
...
*/
int MOAIVoxelProp::_getPriority ( lua_State* L ) {
	MOAI_LUA_SETUP ( MOAIVoxelProp, "U" )
...
*/
int MOAIVoxelProp::_getTexture ( lua_State* L ) {
	MOAI_LUA_SETUP ( MOAIVoxelProp, "U" )
...
*/
int	MOAIVoxelProp::_isVisible ( lua_State* L ) {
	MOAI_LUA_SETUP ( MOAIVoxelProp, "U" )
...
*/
int	MOAIVoxelProp::_inside ( lua_State* L ) {
	MOAI_LUA_SETUP ( MOAIVoxelProp, "U" )
...
/**	@name	setBillboard
	...
	@out	nil
*/
int MOAIVoxelProp::_setBillboard ( lua_State* L ) {
	MOAI_LUA_SETUP ( MOAIVoxelProp, "U" )
...
*/
int MOAIVoxelProp::_setBlendEquation ( lua_State* L ) {
	MOAI_LUA_SETUP ( MOAIVoxelProp, "U" )
...
/** @name	setBlendMode
	...
	@overload	Reset the blend mode to MOAIVoxelProp.BLEND_NORMAL (equivalent to src = GL_ONE, dst = GL_ONE_MINUS_SRC_ALPHA). This will reset the blend function to GL_FUNC_ADD.
	...
	@overload	Set blend mode using one of the Moai presets. This will reset the blend function to GL_FUNC_ADD.
		...
		@in		MOAIVoxelProp self
		@in		number mode					One of MOAIVoxelProp.BLEND_NORMAL, MOAIVoxelProp.BLEND_ADD, MOAIVoxelProp.BLEND_MULTIPLY.
		@out	nil
	
	@overload	Set blend mode using OpenGL source and dest factors. OpenGl blend factor constants are exposed as members of MOAIVoxelProp.
		...
		@out	nil
*/
int MOAIVoxelProp::_setBlendMode ( lua_State* L ) {
	MOAI_LUA_SETUP ( MOAIVoxelProp, "U" )
...
/**	@name	setBounds
	...
	@overload	Set the bounds override.
		...
		@out	nil
*/
int MOAIVoxelProp::_setBounds ( lua_State* L ) {
	MOAI_LUA_SETUP ( MOAIVoxelProp, "U" )
...
/**	@name	setCullMode
	...
	@in		MOAIVoxelProp self
	@opt	number cullMode			Default value is MOAIVoxelProp.CULL_NONE.
	@out	nil
*/
int MOAIVoxelProp::_setCullMode ( lua_State* L ) {
	MOAI_LUA_SETUP ( MOAIVoxelProp, "U" )
...
/**	@name	setDeck
	...
	@out	nil
*/
int MOAIVoxelProp::_setDeck ( lua_State* L ) {
	MOAI_LUA_SETUP ( MOAIVoxelProp, "U" )
...
/**	@name	setDepthMask
	...
	@out	nil
*/
int MOAIVoxelProp::_setDepthMask ( lua_State* L ) {
	MOAI_LUA_SETUP ( MOAIVoxelProp, "U" )
...
/**	@name	setDepthTest
	...
	@in		MOAIVoxelProp self
	@opt	number depthFunc		Default value is MOAIVoxelProp.DEPTH_TEST_DISABLE.
	@out	nil
*/
int MOAIVoxelProp::_setDepthTest ( lua_State* L ) {
	MOAI_LUA_SETUP ( MOAIVoxelProp, "U" )
...
/**	@name	setExpandForSort
	...
	@out	nil
*/
int MOAIVoxelProp::_setExpandForSort ( lua_State* L ) {
	MOAI_LUA_SETUP ( MOAIVoxelProp, "U" )
...
/**	@name	setGrid
	...
	@out	nil
*/
int MOAIVoxelProp::_setGrid ( lua_State* L ) {
	MOAI_LUA_SETUP ( MOAIVoxelProp, "U" )
...
/**	@name	setGridScale
	...
	@out	nil
*/
int MOAIVoxelProp::_setGridScale ( lua_State* L ) {
	MOAI_LUA_SETUP ( MOAIVoxelProp, "U" )
...
/**	@name	setIndex
	...
	@out	nil
*/
int MOAIVoxelProp::_setIndex ( lua_State* L ) {
	MOAI_LUA_SETUP ( MOAIVoxelProp, "U" )
...
/**	@name	setParent
	...
	@out	nil
*/
int MOAIVoxelProp::_setParent ( lua_State* L ) {
	MOAI_LUA_SETUP ( MOAIVoxelProp, "U" )
	...
	self->SetAttrLink ( PACK_ATTR ( MOAIVoxelProp, INHERIT_VISIBLE ), parent, PACK_ATTR ( MOAIVoxelProp, ATTR_VISIBLE ));
...
/**	@name	setPriority
	...
	@out	nil
*/
int MOAIVoxelProp::_setPriority ( lua_State* L ) {
	MOAI_LUA_SETUP ( MOAIVoxelProp, "U" )
...
/**	@name	setRemapper
	...
	@out	nil
*/
int MOAIVoxelProp::_setRemapper ( lua_State* L ) {
	MOAI_LUA_SETUP ( MOAIVoxelProp, "U" )
...
/**	@name	setScissorRect
	...
	@out	nil
*/
int MOAIVoxelProp::_setScissorRect ( lua_State* L ) {
	MOAI_LUA_SETUP ( MOAIVoxelProp, "U" )
...
/**	@name	setShader
	...
	@out	nil
*/
int MOAIVoxelProp::_setShader ( lua_State* L ) {
	MOAI_LUA_SETUP ( MOAIVoxelProp, "U" )
...
*/
int MOAIVoxelProp::_setTexture ( lua_State* L ) {
	MOAI_LUA_SETUP ( MOAIVoxelProp, "U" )
...
/**	@name	setUVTransform
	...
	@out	nil
*/
int MOAIVoxelProp::_setUVTransform ( lua_State* L ) {
	MOAI_LUA_SETUP ( MOAIVoxelProp, "U" )
...
/**	@name	setVisible
	...
	@out	nil
*/
int MOAIVoxelProp::_setVisible ( lua_State* L ) {
	MOAI_LUA_SETUP ( MOAIVoxelProp, "U" )
...
//----------------------------------------------------------------//
void MOAIVoxelProp::AddToSortBuffer ( MOAIPartitionResultBuffer& buffer, u32 key ) {
...
//----------------------------------------------------------------//
bool MOAIVoxelProp::ApplyAttrOp ( u32 attrID, MOAIAttrOp& attrOp, u32 op ) {

	if ( MOAIVoxelPropAttr::Check ( attrID )) {
...
//----------------------------------------------------------------//
void MOAIVoxelProp::Draw ( int subPrimID ) {
	UNUSED ( subPrimID );
...
//----------------------------------------------------------------//
void MOAIVoxelProp::DrawDebug ( int subPrimID ) {
	UNUSED ( subPrimID );
...
//----------------------------------------------------------------//
void MOAIVoxelProp::DrawGrid ( int subPrimID ) {
	...
	if ( subPrimID == MOAIVoxelProp::NO_SUBPRIM_ID ) {
		this->GetGridBoundsInView ( c0, c1 );
	} else {
...
//----------------------------------------------------------------//
void MOAIVoxelProp::GatherSurfaces ( MOAISurfaceSampler2D& sampler ) {
...
//----------------------------------------------------------------//
bool MOAIVoxelProp::GetCellRect ( ZLRect* cellRect, ZLRect* paddedRect ) {
...
//----------------------------------------------------------------//
void MOAIVoxelProp::GetCollisionShape ( MOAICollisionShape& shape ) {
	UNUSED ( shape );
}

//----------------------------------------------------------------//
void MOAIVoxelProp::GetGridBoundsInView ( MOAICellCoord& c0, MOAICellCoord& c1 ) {
...
//----------------------------------------------------------------//
u32 MOAIVoxelProp::GetPropBounds ( ZLBox& bounds ) {
...
//----------------------------------------------------------------//
MOAIPartition* MOAIVoxelProp::GetPartitionTrait () {

	return this->mPartition;
}

//----------------------------------------------------------------//
bool MOAIVoxelProp::Inside ( ZLVec3D vec, float pad ) {
...
int  MOAIVoxelProp::_vec ( lua_State* L ) {
  MOAI_LUA_SETUP ( MOAIVoxelProp, "U" )
...
//----------------------------------------------------------------//
void MOAIVoxelProp::OnDepNodeUpdate () {
	...
	bool visible = ZLFloat::ToBoolean ( this->GetLinkedValue ( MOAIVoxelPropAttr::Pack ( INHERIT_VISIBLE ), 1.0f ));
	this->mFlags = visible && ( this->mFlags & FLAGS_LOCAL_VISIBLE ) ? this->mFlags | FLAGS_VISIBLE : this->mFlags & ~FLAGS_VISIBLE ;	
}

//----------------------------------------------------------------//
void MOAIVoxelProp::RegisterLuaClass ( MOAILuaState& state ) {
	
	MOAITransform::RegisterLuaClass ( state );
	MOAIColor::RegisterLuaClass ( state );
	
	state.SetField ( -1, "ATTR_INDEX",			MOAIVoxelPropAttr::Pack ( ATTR_INDEX ));
	state.SetField ( -1, "ATTR_PARTITION",		MOAIVoxelPropAttr::Pack ( ATTR_PARTITION ));
	state.SetField ( -1, "ATTR_SHADER",			MOAIVoxelPropAttr::Pack ( ATTR_SHADER ));
	state.SetField ( -1, "ATTR_BLEND_MODE",		MOAIVoxelPropAttr::Pack ( ATTR_BLEND_MODE ));
	state.SetField ( -1, "ATTR_VISIBLE",		MOAIVoxelPropAttr::Pack ( ATTR_VISIBLE ));

	state.SetField ( -1, "ATTR_LOCAL_VISIBLE",	MOAIVoxelPropAttr::Pack ( ATTR_LOCAL_VISIBLE ));
	state.SetField ( -1, "ATTR_VISIBLE",		MOAIVoxelPropAttr::Pack ( ATTR_VISIBLE ));
	state.SetField ( -1, "INHERIT_VISIBLE",		MOAIVoxelPropAttr::Pack ( INHERIT_VISIBLE ));

	state.SetField ( -1, "INHERIT_FRAME",		MOAIVoxelPropAttr::Pack ( INHERIT_FRAME ));
	state.SetField ( -1, "FRAME_TRAIT",			MOAIVoxelPropAttr::Pack ( FRAME_TRAIT ));
...
//----------------------------------------------------------------//
void MOAIVoxelProp::RegisterLuaFuncs ( MOAILuaState& state ) {
...
//----------------------------------------------------------------//
void MOAIVoxelProp::Render () {

	this->Draw ( MOAIVoxelProp::NO_SUBPRIM_ID );
}

//----------------------------------------------------------------//
void MOAIVoxelProp::SerializeIn ( MOAILuaState& state, MOAIDeserializer& serializer ) {
...
//----------------------------------------------------------------//
void MOAIVoxelProp::SerializeOut ( MOAILuaState& state, MOAISerializer& serializer ) {
...
//----------------------------------------------------------------//
void MOAIVoxelProp::SetPartition ( MOAIPartition* partition ) {
...
//----------------------------------------------------------------//
void MOAIVoxelProp::SetVisible ( bool visible ) {
...
//----------------------------------------------------------------//
void MOAIVoxelProp::UpdateBounds ( u32 status ) {
...
//----------------------------------------------------------------//
void MOAIVoxelProp::UpdateBounds ( const ZLBox& bounds, u32 status ) {
